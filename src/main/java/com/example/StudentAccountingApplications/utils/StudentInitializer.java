...
/**
 * Initializes the application with predefined students when the application starts.
 * This is conditional on the 'app.init-students' property being set to true.
 */
@Component
